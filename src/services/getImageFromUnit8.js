const getImageMime = (uint8Array) => {
  ...
  if (bytes.startsWith("52494646") && bytes.includes("57454250"))
    return "image/webp";
  if (bytes.includes("6674797068656963")) return "image/heic";
  if (bytes.includes("6674797048656963")) return "image/heic";
  if (bytes.includes("6674797048657669")) return "image/heif";
  if (bytes.includes("667479704d345620")) return "image/mp4";
